        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if (actualBitmap!=null)
                {
                    ...
                    Bitmap bitmap_1 = GetThumbnail(1, new Size(100, 100));
                    Bitmap bitmap_2 = GetThumbnail(2, new Size(100, 100));
                    Bitmap bitmap_3 = GetThumbnail(3, new Size(100, 100));
                    PageScreen1.Image = bitmap_1;
                    PageScreen2.Image = bitmap_2;
                    PageScreen3.Image = bitmap_3;
                }
