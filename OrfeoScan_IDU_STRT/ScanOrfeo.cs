...
namespace OrfeoScan_IDU_STRT
{
    public partial class ScanOrfeo : Form
    {
        ...
        private void btnNextScreen_Click(object sender, EventArgs e)
        {
            ...
            System.Drawing.Image tiffImage = System.Drawing.Image.FromFile(rutaTiff);
            Guid objGuid = tiffImage.FrameDimensionsList[0];
            FrameDimension dimension = new FrameDimension(objGuid);
            int noOfPages = tiffImage.GetFrameCount(dimension);
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            Offset += 31;
            e.Graphics.DrawString(ListaEtiquetas[0].LINEA1, fuente1, new SolidBrush(System.Drawing.Color.Black), startX, startY + Offset);
            Offset += 11;
            e.Graphics.DrawString(ListaEtiquetas[0].LINEA2, fuente1, new SolidBrush(System.Drawing.Color.Black), startX, startY + Offset);
            Offset += 11;
            e.Graphics.DrawString(ListaEtiquetas[0].LINEA3, fuente2, new SolidBrush(System.Drawing.Color.Black), startX, startY + Offset);
            Offset += 11;
            e.Graphics.DrawString(ListaEtiquetas[0].LINEA4, fuente2, new SolidBrush(System.Drawing.Color.Black), startX, startY + Offset);
            Offset += 11;
            e.Graphics.DrawString(ListaEtiquetas[0].LINEA5, fuente2, new SolidBrush(System.Drawing.Color.Black), startX, startY + Offset);
            Offset = 0;
        }
